...
const PRODUCTS = [
  ...
  // ── Try Out SNBT ───────────────────────────────────────────────────────────
  {
    ...
    type: "tryout",
    icon: "📖",
    title: "Paket Try Out SNBT Bulan April",
    description: [],
    price: "Rp 35.000",
    priceSuffix: "",
    features: ["2 kali akses TryOut SNBT lengkap", "Analisis Performa"],
    featured: false,
    order: 8,
  },
  {
    ...
    type: "tryout",
    icon: "📖",
    title: "Paket Try Out SNBT Bulan Oktober",
    description: [],
    price: "Rp 35.000",
    priceSuffix: "",
    features: ["2 kali akses TryOut SNBT lengkap", "Analisis Performa"],
